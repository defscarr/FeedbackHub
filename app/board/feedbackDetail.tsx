...
export default function FeedbackDetail(){
    ...
    const GenerateCards = () => {
        ...
        for (let i = 1; i <= 8; i++){
            ...
            all.push(
                    ...
                    <div className="divide-y px-8 relative ml-4 mt-7" key={i}>           
                        <ol className="border-l border-l-xSlate-500/75">
    ...
    return (
        <main className="flex space-y-6 px-32 py-32 h-screen w-screen">
            <div className="flex-1 flex-col space-y-6 overflow-y-auto scroll-smooth">
...
{/* comment section starts here */}
                ...
                <section className="flex-none flex flex-col rounded-xl bg-white py-8 overflow-y-auto h-3/5">

                    <p className="relative mt-6 ml-8 leading-26 tracking-closer text-18x mb-4 font-bold text-xSlate-600">4 Comments</p>
