export default function Roadmap(){
    return (
        <main className="px-40 pt-20 space-y-12">
            <div className="flex flex-row bg-xSlate-700 px-8 py-6 rounded-xl">
            ...
            <div className="flex flex-row w-full space-x-7">
                <div className="flex flex-col w-1/3 bg-xSlate-50">
                    <span className="mb-8">
                    ...
                    <div className="flex flex-col space-y-6">
                        <div className="flex flex-col p-8 bg-white border-t-4 border-xOrange-300 rounded-lg">
                            ...
                            <div className="mb-4">
                                <h1 className="leading-26 tracking-closer font-bold text-18x text-xSlate-600">More comprehensive reports</h1>
                            ...
                            <div className="flex flex-row items-center mb-4">
                                <span className="rounded-xl text-center bg-xSiolet-50">
                                    <h5 className="text-xIndigo-600 font-semibold text-13x leading-19 py-1.5 px-4">Feature</h5>
                                </span>
                            </div>
                            <div className="flex flex-row items-center">
                                <div className="flex-1 flex items-center">
                                    <span className="flex items-center px-4 py-2 bg-xSiolet-50 rounded-xl">
                                        <span>
                ...
                <div className="flex flex-col  w-1/3 bg-xSiolet-50">
                ...
                <span className="mb-8">
                    ...
                    <div className="flex flex-col space-y-6">
                        <div className="flex flex-col p-8 bg-white border-t-4 border-xFuchisia-600 rounded-lg">
                            <div className="flex flex-row items-center space-x-4 mb-2">
                                <span className="h-2 w-2 rounded-full bg-xFuchisia-600"></span>
                                <span className="flex-1 font-normal text-16x text-xSlate-500">Planned</span>
                            </div>
                            <div className="mb-4">
                                <h1 className="leading-26 tracking-closer font-bold text-18x text-xSlate-600">More comprehensive reports</h1>
                ...
                <span className="mb-8">
                    ...
                    <div className="flex flex-col space-y-6">
                        <div className="flex flex-col p-8 bg-white border-t-4 border-blue-400 rounded-lg">
                            <div className="flex flex-row items-center space-x-4 mb-2">
