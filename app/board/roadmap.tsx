export default function Roadmap(){
        ...
        for(let i = 1; i <= 8; i++){
            ...
            <div className="flex flex-col p-8 bg-white border-t-4 border-xOrange-300 rounded-lg">
                <div className="flex flex-row items-center space-x-4 mb-2">
                    ...
                    <span className="flex-1 font-normal text-13x lg:text-16x text-xSlate-500">Planned</span>
                </div>
                <div className="mb-4">
                    <h1 className="leading-26 tracking-closer font-bold text-13x lg:text-18x text-xSlate-600 cursor-pointer hover:text-xIndigo-600">More comprehensive reports</h1>
                    <p className="text-13x lg:text-16x font-normal text-xSlate-500">It would be great to see a more detailed breakdown of solutions.</p>
                </div>
                ...
                <div className="flex flex-row items-center">
                    <div className="flex-1 flex items-center">
                        <span className="flex items-center cursor-pointer px-4 py-1.5 lg:py-2.5 bg-xSiolet-50 rounded-xl hover:bg-indigo-200">
                            <span>
    ...
    return (
        <main className="flex flex-col pt-0 px-0 pb-24 md:pt-14 md:px-10 md:pb-28 lg:px-40 lg:pt-20 lg:pb-20 space-y-0 md:space-y-12 h-screen w-screen overflow-auto">
            ...
            <section className="sm:hidden flex-1 md:flex overflow-hidden space-x-8">

                <div className="flex flex-col w-1/3">
                    <span className="mb-8 relative">
                        <h1 className="font-bold text-14x lg:text-18x leading-26 tracking-closer text-xSlate-600">Planned (4)</h1>
                        <p className="font-normal text-14x lg:text-16x text-xSlate-500">Ideas prioritized for research</p>
                    </span>
                ...
                <div className="flex flex-col  w-1/3">
                    <span className="mb-8 relative">
                        <h1 className="font-bold text-14x lg:text-18x leading-26 tracking-closer text-xSlate-600">In-Progress (3)</h1>
                        <p className="font-normal text-14x lg:text-16x text-xSlate-500">Currently being developed</p>
                    </span>
                ...
                <div className="w-1/3 flex flex-col">
                    <span className="mb-8">
                        <h1 className="font-bold text-14x lg:text-18x leading-26 tracking-closer text-xSlate-600">Live (1)</h1>
                        <p className="font-normal text-14x lg:text-16x text-xSlate-500">Released features</p>
                    </span>
            ...
            <div className="flex px-6 pt-6 flex-col md:hidden overflow-hidden">
