...
export default function SuggestionPage(){
  ...
  return (
  <>
    <main className="h-screen w-screen flex md:flex-col lg:space-x-10 lg:flex-row lg:px-40 lg:py-32 md:pt-14 md:pb-28 md:px-10">
    
        <aside className="flex md:mb-10 md:flex-row md:space-x-6 lg:flex-col lg:space-y-6 lg:space-x-0"> {/* case 2 */}

            <div className="lg:flex-none md:flex-1 flex pt-24  pl-6 pr-11 pb-6 lg:pt-16 lg:pr-20 flex-col lg:bg-image-lg bg-image-md bg-norepeat rounded-lg"> 
            ...
            <div className="lg:flex-none md:flex-1 flex pt-6 pl-6 pr-4 pb-9 lg:py-6 lg:pt-6 lg:pr-12 bg-white rounded-lg">
            ...
            <div className="lg:flex-none md:flex-1 flex flex-col px-6 pb-6 pt-6 lg:pt-5 bg-white rounded-lg">
      ...
      <div className="flex md:flex-1 lg:flex-row overflow-hidden">  {/* case 1 */}
        ...
        <section className="flex-1 flex flex-col space-y-6 w-full">
          <header className="relative bg-xSlate-700 space-x-9 pl-6 pr-4 rounded-lg flex items-center"> 
