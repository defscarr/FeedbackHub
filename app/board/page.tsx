...
export default function SuggestionPage(){
  ...
  <>
    <main className="h-screen w-screen flex flex-col md:flex-col lg:space-x-10 lg:flex-row lg:px-40 lg:py-32 md:pt-14 md:pb-28 md:px-10">
    
        <aside className="flex md:mb-10 md:flex-row md:space-x-6 lg:flex-col lg:space-y-6 lg:space-x-0"> {/* case 2 */}
            ...
            <div className="sm:hidden lg:flex-none md:flex-1 md:flex pt-6 pl-6 pr-4 pb-9 lg:py-6 lg:pt-6 lg:pr-12 bg-white rounded-lg">
            ...
            <div className="sm:hidden lg:flex-none md:flex-1 md:flex flex-col px-6 pb-6 pt-6 lg:pt-5 bg-white rounded-lg">
      ...
      <div className="flex md:flex-1 lg:flex-row overflow-hidden">  {/* case 1 */}


        <section className="flex-1 flex flex-col space-y-6 w-full">
          <header className="relative flex bg-xSlate-700  md:space-x-9 py-2 px-6 md:pl-6 md:pr-4 rounded-none md:rounded-lg  items-center"> {/*here*/}
            <div className="sm:hidden md:first:flex space-x-4 items-center text-white py-6">
              <span>
          ...
          <div className="hidden md:flex flex-col space-y-4 overflow-y-auto">
            {generateMDList()}
          </div>

          <div className="flex flex-col px-6 pt-8 pb-14 space-y-4 overflow-y-auto md:hidden">
            {GenerateSMlLIST()}
            {/* <Feedback404 /> */}
          </div>
